...
| Command | Purpose |
|---|---|
| `swytchcode list` | Look for locally installed providers |
...
| `swytchcode sync [provider_name]` | Pull new/updated workflows and methods from backend without touching tooling.json. Run when new workflows were created remotely since last `get`. |
