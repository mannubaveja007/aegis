...
export const metadata: Metadata = {
  ...
  description: 'An AI Business Operator Agent that defends itself while it works. Verifies orders, checks real payment risk, refuses manipulation, and blocks unsafe refunds.',
}
